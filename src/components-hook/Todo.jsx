...
const Todo = (props) => {
  ...
  let edit_class = props.editArr.includes(props.item)
    ? "edit-wrapper"
    : "nedit-wrapper";
  return (
    <li className="list" id={props.idx}>
      <div>
        ...
        <button
          className="down"
          onClick={() => props.moveItem("down", props.idx)}
        >
          DOWN
        </button>
      </div>
      ...
      <div className="imgs">
        <div>
          ...
          <img
            ...
            alt="alt"
            className="img"
            onClick={() => props.markAsCompleted(props.idx)}
          />
        </div>
        <div>
          <img
        ...
        <div>
          <img
            ...
            alt="alt"
            className="img"
            onClick={() => props.removeFromList(props.idx)}
          />
        </div>
        <input
          type="checkbox"
      ...
      <div className={edit_class}>
        ...
        <button
          className="button"
          onClick={() => props.handleOnEdit(props.idx, currentEdit)}
        >
          Edit
        </button>
      </div>
