...
class Todo extends React.Component {
  ...
  render() {
    let edit_class = this.props.editArr.includes(this.props.item)
      ? "edit-wrapper"
      : "nedit-wrapper";
    return (
      <li className="list" id={this.props.idx}>
        <div>
          ...
          <button
            className="down"
            onClick={() => this.props.downItem(this.props.idx)}
          >
            DOWN
          </button>
        </div>
        ...
        <div className="imgs">
          <div>
            ...
            <img
              ...
              alt="alt"
              className="img"
              onClick={() => this.props.markAsCompleted(this.props.idx)}
            />
          </div>
          <div>
            <img
          ...
          <div>
            <img
              ...
              alt="alt"
              className="img"
              onClick={() => this.props.removeFromList(this.props.idx)}
            />
          </div>
          <input
            type="checkbox"
        ...
        <div className={edit_class}>
          ...
          <button
            className="button"
            onClick={() =>
              this.props.handleOnEdit(this.props.idx, this.state.currentEdit)
            }
          >
            Edit
          </button>
