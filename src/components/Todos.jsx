        ...
        return (
            <div className="container">
                ...
                <div className="input-line">
                    ...
                    />
                    <button className="button" onClick={this.addOnList}>ADD</button>
                    <button className="button" onClick={this.clearAll}>Clear</button>
                    <button className="button" onClick={this.clearCompleted}>ClearC</button>
                    <button className="button" onClick={this.clearCheckboxed}>ClearCB</button>
                </div>
